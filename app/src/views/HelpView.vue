<template>
  ...
  >
    <b-card title="Der Choreo-Editor" class="w-75" border-variant="primary">
      <b-card-body>
        <b-list-group flush>
          <b-list-group-item>
            <h5>Für wen ist der Editor gedacht?</h5>
            <p>
              Der Editor ist für Trainerinnen und Trainer für
              Cheerleading-Teams. Die Endprodukte (Countsheets, Bilder und
              Videos) sollen an die Teams geteilt werden, um das Einstudieren
              einfacher zu machen.
            </p>
          </b-list-group-item>
          <b-list-group-item>
          ...
          <b-list-group-item>
            <h5>Datenschutz</h5>
            <p>
              Die Nutzung von Daten, die zur Identifikation einer Person genutzt
              ...
              und sind auf Wunsch unmittelbar zu löschen. Dazu nimm bitte per
              Mail an
              <a href="mailto:andreas.nicklaus@gmail.com">
                andreas.nicklaus@gmail.com
              </a>
