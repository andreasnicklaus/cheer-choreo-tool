...
class UserAccessService {
   ...
   * @returns {Promise<Array>} List of user access relationships
   */
  getChildren(): Promise<UserAccess[]> {
   ...
   */
  invite(childEmail: string, role: string): Promise<UserAccess> {
   ...
   */
  update(id: string, data: Partial<UserAccess>): Promise<UserAccess> {
   ...
   * @returns {Promise<Object>} Updated access
   */
  accept(id: string): Promise<UserAccess> {
